...
    Este é um contrato de Termos de uso firmado com você, de agora em diante denominado como usuário, portanto, uma pessoa física, dentro do Brasil e o Aplicativo Anote Tudo desenvolvido para dispositivos móveis (IOs e Android) Se você não concordar com estes termos recomenda-se o não uso deste aplicativo.
...
    O usuário não poderá responsabilizar seus programadores, por quaisquer modificações, suspensões ou descontinuidade do aplicativo.
